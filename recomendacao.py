...
def dist_euclidiana(base,user1, user2):
    si = {}
...
def getSimilares(base,usuario):
    similaridade = [(dist_euclidiana(base,usuario, outro), outro)
...
def getRecomendacoes(base,user):
    ...
    for outro in base:
        ...
        similaridade = dist_euclidiana(base,user, outro)
...
def carregaMovieLens():
    ...
    for linha in open('./dataset/u.item', encoding = 'ISO-8859-1'):
    ...
    for linha in open('./dataset/u.data'):
        (usuario, idFilme, nota, tempo) = linha.split('\t')
        base.setdefault(usuario,{})
        base[usuario][films[idFilme]] = float(nota)
...
def getRecomendacoesItens(base, similaridadeItens, usuario):
